...
type HttpHandlerMsgPack struct {
}
...
func (u *HttpHandlerMsgPack) Get(c echo.Context) error {
	buf, _ := msgpack.Marshal(mockArticle)
...
// func (u *HttpHandlerMsgPack) GetListUser(c echo.Context) error {
//
...
func NewArticleMsgPackDelivery(e *echo.Echo) {
	handler := &HttpHandlerMsgPack{}
	e.GET("/articlemsgpack", handler.Get)
